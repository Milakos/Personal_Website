...
function Buttons()
{
  a = createToggle("Γέννεση", windowWidth -200,windowHeight - 150);
  a.setStyle(
  {
  ...
  b = createToggle("Θάνατος", windowWidth -200,windowHeight - 100);
  b.setStyle(
  {
  ...
  //Reverb
  c = createToggle("Γνώμη",windowWidth - 400 ,windowHeight - 150);
  c.setStyle(
  {
  ...
  d = createCheckbox("Αντιστροφή", windowWidth - 275,windowHeight -100);
  d.setStyle(
  {
    fillBg: color("#70fdff"),
     fillBgHover : color("#56eef0"),
  ...
  e = createSlider("Χρόνος", windowWidth - 400,windowHeight -100,100,32);
  e.setStyle(
  {
     fillBg: color("#70fdff"),
     fillBgHover : color("#56eef0"),
  ...
  f = createSlider("Πτώση", windowWidth - 400,windowHeight -50,100,32);
  f.setStyle(
  {
     fillBg: color("#70fdff"),
     fillBgHover : color("#56eef0"),
  ...
  // Delay
  del = createToggle("Ρουτίνα", windowWidth - 600,windowHeight - 150);
  del.setStyle(
  {
  ...
  dell = createSlider("Διάρκεια", windowWidth - 600,windowHeight -100,100,32);
  dell.setStyle(
  {
     fillBg: color("#1cbd37"),
  ...
  i = createSlider("Ανατροφοδότηση", windowWidth - 600,windowHeight -50,100,32);
  i.setStyle(
  {
     fillBg: color("#1cbd37"),
     fillBgHover : color("#32c74b"),
  ...
  // Distortion
  g = createToggle("Καταστροφή", windowWidth - 800,windowHeight - 150);
  g.setStyle(
  {
  ...
  h = createSlider("Παραμόρφωση", windowWidth - 800,windowHeight - 100,100,32);
  h.setStyle(
  {
     fillBg: color("#b81212"),
  ...
  //Filter
  k = createButton("Κατανόηση", windowWidth - 1000,windowHeight - 150);
  k.setStyle({
    rounding: 20,
    fillBg: color("#653ab0"),
  ...
  //Rate
  rateBtn = createSlider("Ταχύτητα Ζωής", windowWidth - 1600, windowHeight - 150);
  rateBtn.setStyle({
    fillBg: color("#b81212"),
    fillBgHover : color("#a13d30"),
    fillBgActive: color("#b0483a"),
  ...
  // Rec Btn
  recBtn = createCheckbox("Ανασκόπηση",windowWidth - 150 ,windowHeight - 60);
  recBtn.setStyle(
  {
    fillBg: color("#ff0000"),
...
function Texts()
{
  ...
  noStroke();
  fill(0);
  text('Ρυθμός Ζωής',windowWidth - 1500, windowHeight - 155 );
  noStroke();
  fill(0);
  text('Ο άνρθωπος Γεννιέται, μεγαλώνει, αρχίζει να έχει Γνώμη, να Αντιλαμβάνεται τη ζωή γύρω του. Ξεκινάει να έχει συνήθειες και ζεί σε μια Ρουτίνα. Εναντιώνεται σε όλους και όλα. Παίρνει τον δρόμο και την απόφαση της καταστροφής. Μετά έρχεται η πτώση και μαζί της όλα τα εφόδια για καλύτερη Αντίληψη και Κατανόηση. Φιλτράρει τις εμπειρίες του και προσαρμόζει τον ρυθμό της ζωής του και όλα πάλι απο την αρχή μέχρι να κατασταλλάξει στον τρόπο που θέλει να ζεί. Λίγο πρίν το τέλος Ανασκόπηση Ζωής. Τέλος ο Θάνατος',windowWidth - 1630, windowHeight - 110, 430,200 );
  noStroke();
  fill(0);
  text('Μεταβλητές Κατανόησης',windowWidth - 1185, windowHeight - 155);
  noStroke();
  fill(0);
  text('Απόφαση Καταστροφής',windowWidth - 790, windowHeight - 50);
  noStroke();
  fill(0);
  text ('Χρονοκαθυστέρηση',windowWidth - 590, windowHeight - 55);
  noStroke();
  fill(0);
  text ('Εφόδια',windowWidth - 590, windowHeight - 5);
  noStroke();
  fill(0);
  text ('Αντίληψη',windowWidth - 390, windowHeight - 55);
  noStroke();
  fill(0);
  text ('Ενάντια σε όλα',windowWidth - 280, windowHeight - 55);
  noStroke();
  fill(0);
  text('Πτώση',windowWidth - 390, windowHeight - 5);
  textSize(16)
  stroke(4);
  strokeWeight(4);
  fill('red');
  text('Ανασκόπηση Ζωής',windowWidth - 200 ,windowHeight - 7);
} 
